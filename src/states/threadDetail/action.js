...
const asyncCreateComment = (threadId, content) => async (dispatch) => {
  try {
...
const asyncReceiveThreadDetail = (talkId) => async (dispatch) => {
...
const asyncNeutralizeCommentVote = (threadId, commentId) => async (dispatch) => {
  try {
